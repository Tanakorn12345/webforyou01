  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 mt-12 mb-12">
        <div className="bg-pink-100 rounded-3xl p-6 md:p-8 shadow-sm">
          <h2 className="text-xl md:text-2xl font-bold text-pink-500 mb-4 text-center">ยินดีต้อนรับสู่ Pimmie Webpage 🎀</h2>
